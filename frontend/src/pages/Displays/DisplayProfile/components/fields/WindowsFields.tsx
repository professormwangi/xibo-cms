...
export function WindowsFields({
  ...
  if (tab === 'general') {
    return (
      <>
        ...
        />
        <Checkbox
          id="powerpointEnabled"
          title={t('Enable PowerPoint?')}
          label={t(
            'Should Microsoft PowerPoint be Enabled? The Player will need PowerPoint installed to Display PowerPoint files.',
          )}
          checked={bool('powerpointEnabled')}
          onChange={setBool('powerpointEnabled')}
        />
      </>
    );
  }
    ...
    return (
      <>
        ...
        <TextInput
          ...
          value={str('authServerWhitelist')}
          onChange={setStr('authServerWhitelist')}
        />
        <TextInput
          name="edgeBrowserWhitelist"
          ...
          value={str('edgeBrowserWhitelist')}
          onChange={setStr('edgeBrowserWhitelist')}
        />
      </>
    );
  }
  ...
  if (tab === 'troubleshooting') {
    return (
      <>
        <Checkbox
          id="clientInfomationCtrlKey"
          title={t('CTRL Key required to access Player Information Screen?')}
          label={t('Should the Player information screen require the CTRL key?')}
          checked={bool('clientInfomationCtrlKey')}
          onChange={setBool('clientInfomationCtrlKey')}
        />
        <TextInput
          ...
          value={str('clientInformationKeyCode')}
          onChange={setStr('clientInformationKeyCode')}
        />
        <SelectDropdown
          label={t('Log Level')}
        ...
        <TextInput
          ...
          value={str('logToDiskLocation')}
          onChange={setStr('logToDiskLocation')}
        />
      </>
    );
  }
  ...
  if (tab === 'advanced') {
    return (
      <>
        <Checkbox
          id="showInTaskbar"
          title={t('Show the icon in the task bar?')}
          label={t('Should the application icon be shown in the task bar?')}
          checked={bool('showInTaskbar')}
          onChange={setBool('showInTaskbar')}
        />
        <SelectDropdown
          label={t('Cursor Start Position')}
          helper={t('The position of the cursor when the Player starts up.')}
          value={str('cursorStartPosition')}
          options={[
          ...
          onSelect={setStr('cursorStartPosition')}
        />
        <Checkbox
          id="doubleBuffering"
          title={t('Enable Double Buffering')}
          label={t(
            'Double buffering helps smooth the playback but should be disabled if graphics errors occur.',
          )}
          checked={bool('doubleBuffering')}
          onChange={setBool('doubleBuffering')}
        />
        <NumberInput
          ...
          value={num('emptyLayoutDuration')}
          onChange={setNum('emptyLayoutDuration')}
        />
        <Checkbox
          id="enableMouse"
          title={t('Enable Mouse')}
          label={t('Enable the mouse.')}
          checked={bool('enableMouse')}
          onChange={setBool('enableMouse')}
        />
        <Checkbox
